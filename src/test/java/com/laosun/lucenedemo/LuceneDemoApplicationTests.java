...
class LuceneDemoApplicationTests {
    ...
    public void testCreate() throws Exception{
        ...
        //2 索引目录类,指定索引在硬盘中的位置
        Directory directory = FSDirectory.open(new File("/Users/laosun/Desktop/indexDir"));

//        Lucene5.0.0以上
//        Directory directory = FSDirectory.open(Paths.get("/Users/laosun/Desktop/indexDir"));
